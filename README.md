[![CI](https://github.com/solarlime/homepage/actions/workflows/preview.yml/badge.svg?branch=preview)](https://github.com/solarlime/homepage/actions/workflows/preview.yml)

# Homepage

## What:

This is a repository for [my homepage](https://solarlime.dev). This branch is for preview, so it is unstable and can have bugs.
